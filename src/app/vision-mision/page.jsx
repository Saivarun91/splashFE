        ...
        <section className="relative py-20 md:py-32 overflow-hidden bg-[#f8f9fc]">
          ...
          <div className="max-w-screen-xl mx-auto px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-[#313957] max-w-2xl mx-auto leading-relaxed">
              Shaping the future of fashion imagery with AI-powered creativity.
            </p>
          </div>
        </section>
            ...
            <div className="order-1 md:order-2 bg-white p-10 rounded-2xl border border-[#e6e6e6] text-[#0c1421]">
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <p className="text-lg">Instant AI-generated visuals</p>
                </div>
                <div className="flex gap-4">
                  <Users className="text-[#5533ff]" />
                  <p className="text-lg">Built for brands and creative teams</p>
                </div>
                <div className="flex gap-4">
                  <Globe2 className="text-[#5533ff]" />
                  <p className="text-lg">Scales globally with ease</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-screen-xl mx-auto px-6 text-center">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  title: "Innovation",
                  desc: "Pushing boundaries with AI-driven creativity."
                },
                {
                  title: "Speed",
                  desc: "Helping brands go to market faster."
                },
                {
                  title: "Accessibility",
                  desc: "High-quality visuals for everyone."
                },
                {
                  title: "Creative Freedom",
                  desc: "Unlimited experimentation without limits."
                },
                {
                  title: "Reliability",
                  desc: "Consistent, production-ready results."
                },
                {
                  title: "Customer Focus",
                  desc: "Solving real-world fashion challenges."
                }
              ].map((item, index) => (
                <div
                  key={index}
                  className="p-6 bg-white border border-[#e6e6e6] rounded-xl hover:shadow-lg transition-shadow"
                >
        ...
        <section className="py-20 bg-gradient-to-br from-indigo-600 to-purple-500 text-white text-center">
          <div className="max-w-screen-lg mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-tight">
              Build the future of fashion visuals with Splash AI Studio.
            </h2>
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-white text-[#5533ff] hover:bg-gray-100 font-bold px-8 py-6 text-lg rounded-full border border-black"
              >
                Get Started
              </Button>
            </Link>
