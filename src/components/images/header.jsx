            ...
            <div className="flex items-center justify-between">
                <div className="scale-in">
                    <h1 className="text-4xl font-extrabold text-[#1a1a1a] mb-3">
                        {t("images.welcomeToGloAI")}, <span className="bg-gradient-to-r from-[#7753ff] via-[#a855f7] to-[#ec4899] bg-clip-text text-transparent">Ryagati</span>
                    </h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        <span className="text-sm font-bold bg-gradient-to-r from-[#7753ff] to-[#ec4899] bg-clip-text text-transparent">{t("images.gallery")}</span>
                    </button>
                    <div className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border-2 border-green-200 shadow-lg hover-lift">
                        ...
                        <span className="text-sm font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">{t("images.systemActive")}</span>
                    </div>
                </div>
            </div>
        </div>
