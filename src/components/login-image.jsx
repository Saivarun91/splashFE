export default function LoginImage() {
    return (
        <div className="relative w-full h-full min-h-96">
            ...
            <div className="absolute bottom-50 left-10 w-48 h-48 rounded-2xl overflow-hidden shadow-lg z-10">
            ...
            <div className="absolute top-20 right-0 w-100 h-100 rounded-2xl overflow-hidden shadow-2xl">
                <img
